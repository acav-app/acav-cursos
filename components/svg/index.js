...
export const SiteLogo = ({ className, withBg = true, ...props }) => (
  <span
    className={cn(
      "inline-flex items-center justify-center",
      withBg ? "rounded-xl bg-[#1B2B50] p-2" : null
    )}
  >
    <Image
      src="/images/logo.png"
      ...
      quality={100}
      sizes="184px"
      className={cn("h-7 w-auto drop-shadow-[0_2px_8px_rgba(0,0,0,0.35)]", className)}
      {...props}
    />
  </span>
);
