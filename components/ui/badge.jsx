  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      ...
      variant: {
        ...
        soft: "border-transparent text-current bg-current/10",
      },
    },
    compoundVariants: [
      {
      ...
      },
      {
        ...
        color: "secondary",
        className:
          "text-muted-foreground hover:text-muted-foreground bg-secondary",
      },
      {
        variant: "soft",
        color: "dark",
        className: "text-accent-foreground bg-accent-foreground/20 hover:text-accent-foreground",
      },
      {
        variant: "soft",
        color: "default",
