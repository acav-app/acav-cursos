...
export const textareaVariants = cva(
  "flex flex-1 bg-background w-full min-h-[80px] px-3 py-[10px] text-sm whitespace-pre-wrap break-words [overflow-wrap:anywhere] file:border-0 file:bg-transparent file:text-sm file:font-medium read-only:bg-background disabled:cursor-not-allowed disabled:opacity-50 transition duration-300 ",
  {
    variants: {
      color: {
        default:
