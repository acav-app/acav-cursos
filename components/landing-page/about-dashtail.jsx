...
const AboutTucsDigital = () => {
  ...
  return (
    <section className="py-16 2xl:py-[120px]" id="whyTucsDigital">
      <div className="container">

        <div className="max-w-[670px] mx-auto">
          <h2 className="text-center text-xl xl:text-3xl xl:leading-[46px] font-semibold text-default-900 mb-3">
            Why Choose  <span className="text-primary">Tucs Digital</span>
          </h2>
...
export default AboutTucsDigital;
