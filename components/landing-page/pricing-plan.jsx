      ...
      <div className="container">
        ...
        <div className="max-w-[670px] mx-auto ">
          ...
          <p className="text-base xl:leading-7 text-center text-default-700 ">
            Tucs Digital stands as a prudent investment, safeguarding you against thousands in potential expenses.
        ...
        <div className="mt-14">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-y-8 lg:gap-x-12">
            ...
            <div className="bg-default-100 rounded-xl py-10 px-7 flex flex-col">
              ...
              <Button asChild>
                  <Link href="https://1.envato.market/Tucs Digital-regular" target="__blank" className="mt-8 xl:mt-12 w-full">
                    Buy Now
                  </Link>
              </Button>
            </div>
            ...
            <div className="bg-default-100 rounded-xl py-8 px-6 border border-primary relative flex flex-col">
              ...
              <Button asChild>
                  <Link href="https://1.envato.market/Tucs Digital-extended" target="__blank" className="mt-8 xl:mt-12 w-full">
                    Buy Now
                  </Link>
              </Button>
            </div>
