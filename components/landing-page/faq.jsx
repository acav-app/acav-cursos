          ...
          <div>
            <Accordion type="single" collapsible className="space-y-6" >
              ...
              >
                ...
                <AccordionContent className="text-sm xl:text-base text-default-700">
                  Tucs Digital itself doesn&apos;t include Figma design files automatically, but we&apos;re happy to provide them for free upon request. This allows for flexible customization within Figma.
              ...
              >
                <AccordionTrigger className="text-base xl:text-lg text-left font-medium text-default-900">
                  What skills are needed to use Tucs Digital?
                </AccordionTrigger>
                <AccordionContent className="text-sm xl:text-base text-default-700">
                  Using Tucs Digital effectively requires a foundational knowledge of front-end development, particularly with Tailwind and React for deeper customization.
                  It&apos;s important to remember that Tucs Digital is a front-end template;
          ...
          <div>
            <Accordion type="single" collapsible className="space-y-6" >
              ...
              >
                ...
                <AccordionContent className="text-sm xl:text-base text-default-700">
                  The latest Tucs Digital version can always be downloaded from ThemeForest without any extra charge.
              ...
              >
                <AccordionTrigger className="text-base xl:text-lg text-left font-medium text-default-900">
                  Is Tucs Digital worth the investment?
                </AccordionTrigger>
                <AccordionContent className="text-sm xl:text-base text-default-700">
                  Absolutely. Tucs Digital is meticulously crafted to streamline the development process, offering a seamless and efficient way to build your web UI.
              ...
              >
                <AccordionTrigger className="text-base xl:text-lg text-left font-medium text-default-900">
                  How can I get help with Tucs Digital?
                </AccordionTrigger>
                <AccordionContent className="text-sm xl:text-base text-default-700">
