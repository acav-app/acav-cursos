  ...
  return (
    <div className="py-8 px-2 max-w-6xl mx-auto">
      ...
      <div className="rounded-3xl border border-border/60 bg-card p-8">
        ...
        <h1 className="mt-3 text-3xl font-bold text-foreground">Crear curso manualmente</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Carga la propuesta formativa en 3 pasos. Define su modalidad, contenido y condiciones de inscripción desde el panel admin.
        </p>
